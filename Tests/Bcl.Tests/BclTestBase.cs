...
namespace Bcl.Tests
{
    public abstract class BclTestBase : AbpIntegratedTestBase
    {
        protected BclTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<BclApplicationModule>();
            modules.Add<BclDataModule>();
        }

        public void UsingDbContext(Action<BclDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<BclDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<BclDbContext, T> func)
        {
            T result;
